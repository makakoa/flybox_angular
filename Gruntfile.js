...
module.exports = function(grunt) {
  ...
  grunt.initConfig({
    ...
    simplemocha: {
      src: ['test/api/user_tests.js', 'test/api/account_tests.js', 'test/api/box_tests.js', 'test/api/socket_tests.js', 'test/api/email_tests.js']
    },
    ...
    sass: {
      ...
      dist: {
        files: {
          ...
          'build/CSS/landing.css': 'app/sass/landing.sass',
